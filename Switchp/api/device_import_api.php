...
// CORS: restrict to same origin; do not expose this API cross-origin.
// If a specific external origin needs access, set it via the
// ALLOWED_ORIGIN environment variable instead of using a wildcard.
...
/**
 * Send an alarm email via SMTP (delegates to shared EmailService).
 */
function sendAlarmEmail(string $subject, string $htmlBody): bool {
    return EmailService::send($subject, $htmlBody);
}
